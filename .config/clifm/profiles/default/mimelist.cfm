...
X:N:.*\.djvu$=djview;zathura --fork;evince;atril
X:N:.*\.epub$=mupdf;zathura --fork;ebook-viewer
X:N:.*\.mobi$=ebook-viewer
X:N:.*\.(cbr|cbz)$=zathura --fork
...
# PDF
X:.*/pdf$=mupdf;sioyek;llpp;lpdf;zathura --fork;mupdf-x11;apvlv;xpdf;evince;atril;okular;epdfview;qpdfview

# Images
X:^image/gif$=feh;animate;pqiv;sxiv -a;nsxiv -a
X:^image/.*=feh;fim;display;sxiv;nsxiv;pqiv;gpicview;qview;qimgv;inkscape;mirage;ristretto;eog;eom;xviewer;viewnior;nomacs;geeqie;gwenview;gthumb;gimp
!X:^image/*=feh;fim;img2txt;cacaview;fbi;fbv
